...
export const MOCK_APPOINTMENTS: Appointment[] = [
  ...
  { id: 'apt-3', patientId: 'pat-3', doctorId: 'doc-1', type: 'followup', startTime: getWeekDate(0, 11, 30), endTime: getEndTime(getWeekDate(0, 11, 30), 30), status: 'scheduled' },
  ...
  { id: 'apt-8', patientId: 'pat-8', doctorId: 'doc-2', type: 'followup', startTime: getWeekDate(0, 11, 0), endTime: getEndTime(getWeekDate(0, 11, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-12', patientId: 'pat-12', doctorId: 'doc-3', type: 'followup', startTime: getWeekDate(0, 13, 0), endTime: getEndTime(getWeekDate(0, 13, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-16', patientId: 'pat-16', doctorId: 'doc-1', type: 'followup', startTime: getWeekDate(1, 14, 0), endTime: getEndTime(getWeekDate(1, 14, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-20', patientId: 'pat-20', doctorId: 'doc-2', type: 'followup', startTime: getWeekDate(1, 13, 0), endTime: getEndTime(getWeekDate(1, 13, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-23', patientId: 'pat-23', doctorId: 'doc-3', type: 'followup', startTime: getWeekDate(1, 14, 30), endTime: getEndTime(getWeekDate(1, 14, 30), 30), status: 'scheduled' },
  ...
  { id: 'apt-28', patientId: 'pat-28', doctorId: 'doc-1', type: 'followup', startTime: getWeekDate(2, 15, 30), endTime: getEndTime(getWeekDate(2, 15, 30), 30), status: 'scheduled' },
  ...
  { id: 'apt-31', patientId: 'pat-31', doctorId: 'doc-2', type: 'followup', startTime: getWeekDate(2, 12, 0), endTime: getEndTime(getWeekDate(2, 12, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-36', patientId: 'pat-36', doctorId: 'doc-1', type: 'followup', startTime: getWeekDate(3, 15, 30), endTime: getEndTime(getWeekDate(3, 15, 30), 30), status: 'scheduled' },
  ...
  { id: 'apt-39', patientId: 'pat-39', doctorId: 'doc-2', type: 'followup', startTime: getWeekDate(3, 13, 30), endTime: getEndTime(getWeekDate(3, 13, 30), 30), status: 'scheduled' },
  ...
  { id: 'apt-42', patientId: 'pat-42', doctorId: 'doc-3', type: 'followup', startTime: getWeekDate(3, 14, 0), endTime: getEndTime(getWeekDate(3, 14, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-46', patientId: 'pat-46', doctorId: 'doc-1', type: 'followup', startTime: getWeekDate(4, 13, 0), endTime: getEndTime(getWeekDate(4, 13, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-49', patientId: 'pat-49', doctorId: 'doc-2', type: 'followup', startTime: getWeekDate(4, 12, 0), endTime: getEndTime(getWeekDate(4, 12, 0), 30), status: 'scheduled' },
  ...
  { id: 'apt-52', patientId: 'pat-2', doctorId: 'doc-3', type: 'followup', startTime: getWeekDate(4, 15, 0), endTime: getEndTime(getWeekDate(4, 15, 0), 30), status: 'scheduled' },
...
// Export the data arrays for backward compatibility
export const doctors = MOCK_DOCTORS;
export const patients = MOCK_PATIENTS;
